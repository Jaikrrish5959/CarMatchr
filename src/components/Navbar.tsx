            ...
            <>
              {user.role === 'buyer' && (
                <div style={{ position: 'relative', marginRight: '8px', display: 'flex', alignItems: 'center' }}>
                  ...
                  {offers.filter(o => !o.isRead && requirements.find(r => r.id === o.requirementId)?.buyerId === user.id).length > 0 && (
                    <span style={{
                      ...
                      {offers.filter(o => !o.isRead && requirements.find(r => r.id === o.requirementId)?.buyerId === user.id).length}
                    </span>
                  )}
                </div>
              )}
